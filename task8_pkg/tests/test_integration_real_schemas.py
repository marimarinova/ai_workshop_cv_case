...
def test_evaluator_runs_on_canonical_task1_schemas():
    ...
    gts = [Event(event_id="e1", clip_id="c", type="pickup", t_start=1.0, t_end=2.0),
           Event(event_id="e2", clip_id="c", type="putdown", t_start=5.0, t_end=6.0)]
    pr = [Prediction(pred_id="p1", clip_id="c", type="pickup", t_start=1.1, t_end=2.1, score=0.9, model="m"),
          Prediction(pred_id="p2", clip_id="c", type="pickup", t_start=5.0, t_end=6.0, score=0.7, model="m")]
