...
from pickup_putdown.evaluation import (
    Criterion, EvaluationEvent as Event, EvaluationPrediction as Prediction,
...
def test_block_matching_works_with_plain_enum():
    ...
    pr = [Prediction("c", EventType.pickup, 1.0, 2.0), Prediction("c", EventType.putdown, 5.0, 6.0)]
...
def test_per_type_confusion_ap_with_plain_enum():
    ...
    pr = [Prediction("c", EventType.pickup, 1.0, 2.0, score=0.9),
